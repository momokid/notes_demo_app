      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/notes" class="<?= urlIs("/post") ? "bg-gray-900 text-white" : "text-gray-300"; ?>  hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Note</a>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            ...
            <!--
              ...
              -->
            <div class="sr-only absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
